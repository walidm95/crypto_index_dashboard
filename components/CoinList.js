  ...
  return (
    <div className="max-h-[calc(100vh-200px)]">
      ...
      <TableHeader className="sticky top-0 z-10">
          <TableRow>
            <TableHead className="bg-white w-1/4 py-2" onClick={() => onSort('symbol')}>
              Name {getSortIcon('symbol')}
            </TableHead>
            <TableHead className="bg-white w-1/4 text-right py-2" onClick={() => onSort('price')}>
              Price {getSortIcon('price')}
            </TableHead>
            <TableHead className="bg-white w-1/4 text-right py-2" onClick={() => onSort('volume')}>
              Volume {getSortIcon('volume')}
            </TableHead>
            <TableHead className="bg-white w-1/4 text-right py-2" onClick={() => onSort('priceChange')}>
